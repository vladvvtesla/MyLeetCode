...
The insert method is called n number of times. Together with the float method, the
insert operation takes a worst case runtime of O(n log n), as does the pop method. As
such, this sorting algorithm incurs a worst case runtime of O(n log n).
"""
